    ...
    <div class="wrap options-container">
        ...
        <form action="options.php" method="POST">
            ...
            <table class="options-table">
                <tr>
                    <td><label><?php _e('Phone Number', 'sideout'); ?></label></td>
                    <td>
                        <input type="text" name="sideout_theme_options[phonenumber]" size="40"
                               value="<?php echo esc_attr($options['phonenumber']); ?>"/></td>
                </tr>
                <tr>
                    <td><label><?php _e('Facebook', 'sideout'); ?></label></td>
                    <td>
                        <input type="text" name="sideout_theme_options[facebookurl]" size="40"
                               value="<?php echo esc_url($options['facebookurl']); ?>"/></td
                </tr>
                <tr>
                    <td><label><?php _e('Twitter', 'sideout'); ?></label></td>
                    <td>
                        <input type="text" name="sideout_theme_options[twitterurl]" size="40"
                               value="<?php echo esc_url($options['twitterurl']); ?>"/></td
                </tr>
                <tr>
                    <td><label><?php _e('Google', 'sideout'); ?></label></td>
                    <td>
                        <input type="text" name="sideout_theme_options[googleurl]" size="40"
                               value="<?php echo esc_url($options['googleurl']); ?>"/></td
                </tr>
            </table>
            <hr>
            ...
            <table class="options-table">
                <tr>
                    ...
                    <td><select name="sideout_theme_options[sideout_onetwo]" class="select-options-dropdown">
                            ...
                            <option
                                value="c12" <?php if ($options_selected['sideout_onetwo'] == 'c12') echo 'selected="selected"'; ?>><?php _e('ONE COLUMN', 'sideout'); ?> </option>
                            <option
                                value="onetwo" <?php if ($options_selected['sideout_onetwo'] == 'onetwo') echo 'selected="selected"'; ?>><?php _e('TWO COLUMN', 'sideout'); ?> </option>
            ...
            <table class="options-table">
                <tr>
                    ...
                    <td><input type="text" name="sideout_theme_options[backgrnd]" size="20"
                               value="<?php echo esc_attr($options['backgrnd']); ?>" class="sideout-color-field"/></td>
                </tr>
            </table>
            <hr>
            ...
            <table class="options-table">
                <tr>
                    <td>
                        <h4><?php _e('Type in <code>none</code> to confirm. OR delete <code>none</code> to display.', 'sideout'); ?></h4>
                    </td>
                </tr>
                <tr>
                    <td><input name="sideout_theme_options[sideout_confirm]" size="10" type="text" id="sideout_confirm"
                               value="<?php echo $options['sideout_confirm']; ?>"/></td>
                </tr>
                <tr>
                    <td><?php _e('Once you remove this title text the alternative is to write title in manually at the beginning of the article post. Removing title and date gives you better control of header usage.', 'sideout'); ?></td>
                </tr>
            </table>
            <hr>
            ...
            <table class="options-table">
                <tr>
                    <td><input name="sideout_theme_options[sideout_credits]" id="sideout_credits" type="checkbox"
                               value="1" <?php echo esc_attr($current); ?> />
                        <small><?php _e('You do not have to leave footer credits but it would be nice.', 'sideout'); ?></small>
                    </td>
                </tr>
                <tr>
                    <td><p><?php _e('Replace the footer credit with your own text here', 'sideout'); ?></p>
                        <input id="sideout_new_text" name="sideout_theme_options[sideout_new_text]" size="40"
                               type="text"
                               value="<?php if (!empty($options['sideout_new_text'])) echo esc_attr($options['sideout_new_text']); ?>"/>
                    </td>
                </tr>
            </table>
            <hr>
