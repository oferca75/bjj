...
function smart_magazine_register_posts_grid_1_widgets()
{
    register_widget('smart_magazine_posts_grid_1_widget');
}

add_action('widgets_init', 'smart_magazine_register_posts_grid_1_widgets');


class smart_magazine_posts_grid_1_widget extends WP_Widget
{
    function __construct()
    {
        $widget_ops = array('classname' => 'gum_grid_block_1', 'description' => __('Posts block 1', 'smart-magazine'));
        parent::__construct('smart-magazine-gum-posts-grid-1', __('Posts Grid 1', 'smart-magazine'), $widget_ops);
    }
