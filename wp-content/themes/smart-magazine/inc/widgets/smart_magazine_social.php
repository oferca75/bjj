...
class smart_magazine_social_widget extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('facebook_link'); ?>"><?php _e('Facebook:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['facebook_link']); ?>"
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('twitter_link'); ?>"><?php _e('Twitter:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['twitter_link']); ?>"
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('googleplus_link'); ?>"><?php _e('Googleplus:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['googleplus_link']); ?>"
                   name="<?php echo $this->get_field_name('googleplus_link'); ?>"
                   id="<?php echo $this->get_field_id('googleplus_link'); ?>"/>
        </p>

        <p>
            <label
                for="<?php echo $this->get_field_id('youtube_link'); ?>"><?php _e('Youtube:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['youtube_link']); ?>"
