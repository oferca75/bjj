...
HTML;
    ...
    function form($instance)
    {
        ...
        <p>
            <input id="<?php echo $this->get_field_id('random'); ?>"
                   name="<?php echo $this->get_field_name('random'); ?>" type="checkbox"
                   value="1" <?php checked('1', $instance['random']); ?>/>
            <label
                for="<?php echo $this->get_field_id('random'); ?>"><?php _e('Random Posts', 'smart-magazine'); ?></label>
        </p>
        <p>
            <label
