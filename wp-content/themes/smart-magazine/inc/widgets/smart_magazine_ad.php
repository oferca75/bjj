...
class smart_magazine_ad_widget extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('ad_image'); ?>"><?php _e('Ad Image:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['ad_image']); ?>"
                   name="<?php echo $this->get_field_name('ad_image'); ?>"
                   id="<?php echo $this->get_field_id('ad_image'); ?>"/>
            <?php _e('Upload your ad image in media and past image url here', 'smart-magazine'); ?>
        </p>

        <p>
            <label
                for="<?php echo $this->get_field_id('ad_link'); ?>"><?php _e('Ad Link:', 'smart-magazine'); ?></label>
            <input class="widefat" type="text" value="<?php echo esc_attr($instance['ad_link']); ?>"
