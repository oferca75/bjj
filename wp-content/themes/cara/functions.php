...
{
    ?>
    <a id="sidebar-toggle-open" title="<?php echo esc_attr(cara_string('sidebar-toggle-open')); ?>"
       href="#sidebar-primary-wrap"><span
            class="screen-reader-text"><?php echo cara_string('sidebar-toggle-open'); ?></span></a>
    <?php
}
...
{
    ?>
    <a id="sidebar-toggle-close" title="<?php echo esc_attr(cara_string('sidebar-toggle-close')); ?>"
       href="#sidebar-toggle-close"><span
            class="screen-reader-text"><?php echo cara_string('sidebar-toggle-close'); ?></span></a>
    <?php
}
