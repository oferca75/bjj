            ...
            <div class="camera_wrap" id="camera_wrap_1">
                ...
                <?php if ('' != of_get_option('sc_slide1_image', get_template_directory_uri() . '/inc/images/bride.jpg')) { ?>
                    <div class="camera_inner"
                         data-thumb="<?php echo of_get_option('sc_slide1_image', get_template_directory_uri() . '/inc/images/bride.jpg') ?>"
                         data-src="<?php echo of_get_option('sc_slide1_image', get_template_directory_uri() . '/inc/images/bride.jpg') ?>">
                ...
                <?php if ('' != of_get_option('sc_slide2_image', get_template_directory_uri() . '/inc/images/jesse.jpg')) { ?>
                    <div
                        data-thumb="<?php echo of_get_option('sc_slide2_image', get_template_directory_uri() . '/inc/images/jesse.jpg') ?>"
                        data-src="<?php echo of_get_option('sc_slide2_image', get_template_directory_uri() . '/inc/images/jesse.jpg') ?>">
                        <div class="camera_caption moveFromRight">
                ...
                <?php if ('' != of_get_option('sc_slide3_image', get_template_directory_uri() . '/images/demo-orange.png')) { ?>
                    <div
                        data-thumb="<?php echo of_get_option('sc_slide3_image', get_template_directory_uri() . '/images/demo-orange.png') ?>"
                        data-src="<?php echo of_get_option('sc_slide3_image', get_template_directory_uri() . '/images/demo-orange.png') ?>">
                        <div class="camera_caption moveFromRight">
...
{
    ?>
    <div id="site-cta" class="row <?php echo of_get_option('sc_slider_bool', 'yes') == 'yes' ? '' : 'no-slider' ?>">
        <!-- #CTA boxes -->
        <!--        
        ...
        <div class="col4 site-cta">
            <div style="background-image: url('<?php echo of_get_option('sc_box1_image'); ?>');">
                <div class="overlay">
                    ...
                    <p class="mt20">
                        <a href="<?php echo of_get_option('sc_cta1_url') ?>"
        ...
        <div class="col4 site-cta mid">
            <div style="background-image: url('<?php echo of_get_option('sc_box2_image'); ?>');">
                <div class="overlay">
                    ...
                    <p class="mt20">
                        <a href="<?php echo of_get_option('sc_cta2_url') ?>"
                           class="button button-default button-primary">
                            Click Here
                        </a>
                    </p>
        ...
        <div class="col4 site-cta">
            <div style="background-image: url('<?php echo of_get_option('sc_box3_image'); ?>');">
                <div class="overlay">
                    ...
                    <p class="mt20">
                        <a href="<?php echo of_get_option('sc_cta3_url') ?>"
                           class="button button-default button-primary">
                            Click Here
                        </a>
                    </p>
